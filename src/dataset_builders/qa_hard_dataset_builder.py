...
if __name__ == "__main__":
    ...
    dataset = datasets.load_dataset("src/dataset_builders/qa_hard_dataset_builder.py", download_mode="force_redownload", load_from_cache_file=False)#, ignore_verifications=True)
