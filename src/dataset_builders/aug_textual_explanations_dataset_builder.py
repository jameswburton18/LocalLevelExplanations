...
if __name__ == "__main__":
    ...
    dataset = datasets.load_dataset("src/dataset_builders/aug_textual_explanations_dataset_builder.py", download_mode="force_redownload")#, ignore_verifications=True)
