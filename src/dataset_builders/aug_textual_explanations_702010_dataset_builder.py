...
if __name__ == "__main__":
    ...
    dataset = datasets.load_dataset("src/dataset_builders/aug_textual_explanations_702010_dataset_builder.py", download_mode="force_redownload")#, ignore_verifications=True)
    
    # Save the dataset to huggingface
    dataset.push_to_hub("aug-text-exps-702010", private=True)
    print()